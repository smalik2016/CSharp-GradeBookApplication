...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts.Length != 4)
            {
                Console.WriteLine("command not valid, create requires a name and type of gradebook, if it's weighted (true / flase).");
                return;
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Create 'name' 'type' - creates a new gradebook where 'name' " +
                "is the name of the gradebook and 'type' is what type of grading it should use, and " +
